define(function () {
	...
	WirePositionComponent.prototype = {
		...
		_onMouseDown: function(mouseInput) {
		...
		_onMouseUp: function(mouseInput) {
			let polyLength = this._polyline.length;
		...
		_onMouseMove: function(mouseInput) {
		...
		isOnSegment: function (xp, yp, x1, y1, x2, y2) {		//TODO refactor (false positive occurs
